...
Execute unit tests
```
    cd "FarmerMarketAPI.DiscoutRuleEngine/test/FarmerMarketAPI.DiscoutRuleEngine.Tests"
    dotnet test
```

Deploy application
```
    cd "FarmerMarketAPI.DiscoutRuleEngine/src/FarmerMarketAPI.DiscoutRuleEngine"
